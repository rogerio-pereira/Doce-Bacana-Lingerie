 ...
 */
	...
	class produto 
	{
		...
		?>
			<h1>Produto</h1>
			<form class="formulario" name="salvaProduto"	method="post" onsubmit="validaProduto()">
				...
				<table class='tabelaFormulario'>
					...
					<tr>
						...
						<td>
							<input type='checkbox' name='tamanhoPP' class='chkTamanhoPP'	value='1'>PP
							<input type='checkbox' name='tamanhoP'	class='chkTamanhoP'		value='1'	checked>P
							<input type='checkbox' name='tamanhoM'	class='chkTamanhoM'		value='1'	checked>M
							<input type='checkbox' name='tamanhoG'	class='chkTamanhoG'		value='1'	checked>G
							<input type='checkbox' name='tamanhoGG' class='chkTamanhoGG'	value='1'	checked>GG
							<input type='checkbox' name='tamanho48' class='chkTamanho48'	value='1'>48
							<input type='checkbox' name='tamanho50' class='chkTamanho50'	value='1'>50
							<input type='checkbox' name='tamanho52' class='chkTamanho52'	value='1'>52
							<input type='checkbox' name='tamanho54' class='chkTamanho54'	value='1'>54
						</td>
					</tr>
					<tr>
						<td colspan='2'>
